 ...
 * 2018-11-28T13:15:53.738+08:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "WeatherWS",
                  wsdlLocation = "file:/home/wdy/Downloads/WeatherWS.xml",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/wdy/Downloads/WeatherWS.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/wdy/Downloads/WeatherWS.xml");
        }
        WSDL_LOCATION = url;
    }
