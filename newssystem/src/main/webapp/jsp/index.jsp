...
<nav class="navbar navbar-default header navbar-fixed-top">
  <div class="col-md-12 nav-wrapper">
    <div class="navbar-header" style="width:100%;">
      ...
      <a href="/index.do" class="navbar-brand"> <b>首页</b> </a>
      <ul class="nav navbar-nav navbar-right user-nav">
        ...
        <li class="dropdown avatar-dropdown">
          ...
          <ul class="dropdown-menu user-dropdown">
              ...
              <%--<li><a href="#"><p value="${user.username}" id="backli1" onclick="back()"><span class="fa fa-power-off"></span> 修改信息</p></a></li>--%>
          </ul>
        </li>
      </ul>
    </div>
                  ...
                  <ul class="normal-list">
                      ...
                      <%--<%}%>--%>
                        <c:forEach items="${newslist}" var="list">
                          <li class="text-left"><span class="right">${list.newsdate}</span><a href="shownewsdetail.do?newsfile=${list.newsfile}&newstitle=${list.newstitle}&newsauthor=${list.newsauthor}&newsdate=${list.newsdate}"><span class="fa fa-angle-right"></span>${list.newstitle}</a></li>
                        </c:forEach>
                  </ul>
                  <p><a href="#">更多信息</a></p>
                  <hr/>
